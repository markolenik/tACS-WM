...
trl = arrayfun(@(x) max(size(x.trial)), datlist);
indx = find(trl > 80);
...
% compare to pre
desynch_list_post = datlist(arrayfun(@(x) strcmp(x.condition, 'desynch') ...
                                && strcmp(x.record, 'dur_post_stim'), ...
                                datlist));
synch_list_post = datlist(arrayfun(@(x) strcmp(x.condition, 'synch') ...
                       && strcmp(x.record, 'dur_post_stim'), ...
                                datlist));
sham_list_post = datlist(arrayfun(@(x) strcmp(x.condition, 'desynch') ...
                                && strcmp(x.record, 'dur_post_stim'), ...
                                datlist));

desynch_list_pre = datlist(arrayfun(@(x) strcmp(x.condition, 'desynch') ...
                                && strcmp(x.record, 'pre_stim'), ...
                                datlist));
synch_list_pre = datlist(arrayfun(@(x) strcmp(x.condition, 'synch') ...
                       && strcmp(x.record, 'pre_stim'), ...
                                datlist));
sham_list_pre = datlist(arrayfun(@(x) strcmp(x.condition, 'desynch') ...
                                && strcmp(x.record, 'pre_stim'), ...
                                datlist));
%% try stats
